...
# fetch OVMF image
mkdir ./ovmf
wget http://snapshots.linaro.org/components/kernel/leg-virt-tianocore-edk2-upstream/latest/QEMU-AARCH64/RELEASE_CLANG35/QEMU_EFI.fd -O ovmf/QEMU_EFI_AARCH64.fd
